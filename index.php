        ...
        <div class="StandardPost" id="<?php echo esc_attr($menu_anchor) ?>">
          <div class="StandardPostComp">
            ...
            <div class="Photos">
              <?php 
                if ($isCustomDesign) { ?>
                  <img src="<?php echo $image_array[0] ?>" alt="" class="BigPhoto">
                  <img src="<?php echo $image_array[1] ?>" alt="" class="SmallPhoto">
                  <img src="<?php echo $image_array[2] ?>" alt="" class="SmallPhoto">
                <?php } 
                else { 
                  foreach($image_array as $image) {
                  ?>
                    <img src="<?php echo $image ?>" alt="" class="SmallPhoto">
                <?php } }?>
          ...
          <div class="StandardPostMobile">
            <div class="swiper">
              ...
              <?php
                foreach($image_array as $image) { ?>
                <div class="swiper-slide">
                  <img src="<?php echo $image ?>" alt="" class="BigPhoto">
                </div>
                <?php } ?>
              </div>
              <div class="swiper-pagination"></div>
      ...
      ?>
        <div class="LeftRightPost" id="<?php echo esc_attr($menu_anchor) ?>">
          <div class="LeftRightPostComp">
            <img src="<?php echo $image_array[0] ?>" class="MainPhoto" alt="">
            <div class="Desc">
              <h2><?php the_title() ?></h2>
              <div class="Text">
                <?php the_content() ?>
